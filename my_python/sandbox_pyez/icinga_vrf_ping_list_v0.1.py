...
def get_args():
    ...
    return hostname, username, password, vrf, destination, ips, debug


# Read in Arguments passed to the script
remote_host, remote_username, remote_password, vrf, destination, ips, debug = get_args()
...
print(remote_host, remote_username, remote_password, vrf, destination, ips, debug)
print(remote_host_ipv4, remote_username, remote_password, vrf, destination, ips, debug)
for i in ips:
  print(i)
