...
def ping_vrf(ne: str,
    ...
    try:                                        # open Netconf session with the NE
        ne_ipv4 = socket.getaddrinfo(ne, None, socket.AF_INET)[0][4][0]     # interrogate over IPv4
        ne_ipv6 = socket.getaddrinfo(ne, None, socket.AF_INET6)[0][4][0]  # interrogate over IPv6
        ne_ip = ne_ipv6     # Netconf over IPv6 takes 25 seconds to open in ACX2200 -> timeout
...
if __name__ == '__main__':
    ...
    test_l3vpn_ipv6s = ["2001:0770:0100:6836::2", "2001:0770:0100:6840::2", "2001:0770:0100:6844::2"]
