...
def check_junos_bgp_session(ne: str,
    ...
    The function will check BGP peer session with/for:
    ...
    for bgp_peer in bgp_peers:
        ...
        # Unless a specific routing-instance has been passed as input, the below will default to "".
        # JUNOS will be happy with "", the use/not of routing-instance name is optional.
        ...
        # I put in its own variable so that lines do not grow forever in lenght, that is all.
        ...
        peer_stats['advertised_prefix_count'] = dict_peer_rib['advertised-prefix-count'][0]['data']
...
def example_of_use():
    ...
    bgp_peer_41 = "87.44.68.38"            # does exist, should return success
    bgp_peer_61 = "2001:770:100:6836::2"
    bgp_peers = [bgp_peer_61] + [bgp_peer_40] + [bgp_peer_41]
    bgp_peers = [bgp_peer_41]
